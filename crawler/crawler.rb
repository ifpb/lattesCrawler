...
[
  ...
  # '32001010004P6', #UFMG ok +/- colaboradores
  # '25001019004P6', #UFPE ok [embedded]
  # '25001019062P6', #UFPE ok [embedded+/-]
  # '41001010025P2', #UFSC ok +/-
  # '33002045004P1', #USP/SC ok Colaboradores Externos
  ...
  # '22003010016P9', #UECE ok Profissinal 
  # '53001010098P3', #UNB ok Profissional
  # '51001012038P1', #UFMS ok
  # '40006018011P7', #UTFPR ok
  # '42007011006P5', #UNISINOS ok
  # '42009014011P1', #FUPF ok
  # '41002016023P2', #UDESC ok
  # '25004018011P1', #UPE ok
  # '20002017004P9', #UEMA ok +/- (5M) Reinaldo Jesus Silva, Mauro Sergio Silva Pinto, Josenildo Costa Silva, Henrique Mariano Costa Amaral, Cicero Costa Quarto
  # '31001017004P3', #UFRJ [embedded^2]
  # '25019015001P0', #CESAR ok Profissional
  # '23001011071P0', #UFRN ok Profissional [embedded+/-]
